...
const renderContent = () => {
  ...
  let cargoSection = renderSection(
    "icarus-terminal-cargo",
    "Cargo",
  ...
  let materialsSection = renderSection(
    "icarus-terminal-materials",
    "Materials",
  ...
  let exobiologySection = renderSection(
    "icarus-terminal-plant",
    "Exobiology",
    "Catalog of discovered lifeforms",
  );
  exobiologySection.classList.add("exobiology");
  exobiologySection.style = "--animation-order: 3";
  main.appendChild(exobiologySection);

  let systemSection = renderSection(
    "icarus-terminal-system-bodies",
    "System",
  ...
  footer.innerHTML = "Some Useful content here in the future...";
